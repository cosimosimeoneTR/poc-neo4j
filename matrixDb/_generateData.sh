...
nohup ./randomData.relations.matrixDb.py  2   4   1000000   /mnt/dataDisk/matrix/  >> `basename $0`.log  2>&1
nohup ./randomData.relations.matrixDb.py  4   2   1000000   /mnt/dataDisk/matrix/  >> `basename $0`.log  2>&1
