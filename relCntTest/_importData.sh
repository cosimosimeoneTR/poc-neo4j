...
neo4j-import          \
  ...
  --nodes   UnkNode17.csv.gz                      \
  --nodes   UnkNode18.csv.gz                      \
  --nodes   UnkNode19.csv.gz                      \
  --nodes   UnkNode20.csv.gz                      \
  --nodes   UnkNode21.csv.gz                      \
  --nodes   UnkNode22.csv.gz                      \
  --nodes   UnkNode23.csv.gz                      \
  --nodes   UnkNode24.csv.gz                      \
  --nodes   UnkNode25.csv.gz                      \
  ...
  --relationships   UnkNode172UnkNode18.csv.gz  \
  --relationships   UnkNode182UnkNode19.csv.gz  \
  --relationships   UnkNode192UnkNode20.csv.gz  \
  --relationships   UnkNode202UnkNode21.csv.gz  \
  --relationships   UnkNode212UnkNode22.csv.gz  \
  --relationships   UnkNode222UnkNode23.csv.gz  \
  --relationships   UnkNode232UnkNode24.csv.gz  \
  --relationships   UnkNode242UnkNode25.csv.gz  \
  --relationships   UnkNode252UnkNode17.csv.gz  \
  >> $logFileName 2>&1
